...
export default function Experience() {
  return (
    <div id="Experience" className="max-w-6xl mx-auto px-4 md:px-6 py-12">
      {/* Header */}
      <h1 className="text-3xl md:text-5xl text-center mb-7 md:mb-9 mt-22 md:mt-18 font-semibold text-[#FFC20D]">
      ...
      <div className="space-y-8">
        {experience.map((exp, index) => (
          <div key={index} className="flex">
            ...
            {/* Experience Card */}
            <div className="mb-8 mt-3 flex-1">
              <motion.div
                initial={{ opacity: 0, y: 50 }}
                whileInView={{ opacity: 1, y: 0 }}
                whileHover={{ scale: 1.02 }}
                transition={{ duration: 0.5, delay: index * 0.2 }}
                className="md:flex items-center gap-6 p-6 border rounded-lg shadow-lg bg-[#141414]/40 border-[#FFF2F2]/50 py-3 md:py-9"
              >
                {/* Logo */}
