...
function Projects() {
  return (
    <div id="Projects" className="min-h-screen flex flex-col justify-center items-center bg-[#121212] text-white py-12">
      {/* Header */}
      <h1 className="text-4xl md:text-4xl text-center font-semibold text-[#FFC20D] mb-12 mt-12 md:mt-15">
        Projects
        <motion.span
      ...
      {/* Projects Grid */}
      <div className="grid md:grid-cols-2 lg:grid-cols-2 gap-10 w-full max-w-7xl px-6 md:px-12">
