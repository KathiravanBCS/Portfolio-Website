...
import { FaGithub, FaLinkedin, FaInstagram, FaCode, FaTerminal } from "react-icons/fa";
...
function Footer() {
  ...
  const socials = [
    { icon: FaGithub, url: "https://github.com/Kathiravanbcs2005", color: "#f5f5f5" },
    { icon: FaLinkedin, url: "https://www.linkedin.com/in/kathiravan-v-9b026424b", color: "#0A66C2" },
    { icon: FaInstagram, url: "https://www.instagram.com/kathiravan_2004/", color: "#E4405F" },
    { icon: CiMail, url: "mailto:Kathiravanvittopa717@gmail.com", color: "#EA4335" }
  ];
      ...
      <footer className="max-w-7xl mx-auto py-8 px-4 md:px-10 flex flex-col md:flex-row justify-between items-center">
        ...
        <div className="flex flex-col items-center gap-5">
          ...
          >
            {socials.map((social, index) => (
              ...
              >
                ...
                >
                  {social.url.includes("github") ? "GitHub" : 
                   social.url.includes("linkedin") ? "LinkedIn" : 
                   social.url.includes("instagram") ? "Instagram" : "Email"}
                </motion.span>
              </motion.div>
            ))}
          </motion.div>
          ...
          <p className="text-[#FAFAF9] text-sm font-semibold tracking-wide">
            &copy; {new Date().getFullYear()} Kathiravan V. All rights reserved.
          </p>
        </div>
      </footer>
    </motion.div>
